...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "MNMPullToRefresh/pull-to-refresh/MNMPullToRefresh/MNMPullToRefreshIcon.png"
  install_resource "MNMPullToRefresh/pull-to-refresh/MNMPullToRefresh/MNMPullToRefreshIcon@2x.png"
